			...
			if (line.length() == 1) {
				...
				case 'A': // Add a Patient
					try {
						...
						System.out.print(
								"Please specify the condition of the patient (High Priority, Intermediate, Delayed Care):\n");
				...
				case 'R': // Release Patient From its Doctor
					try {
						...
						if (releasedPatient == null) {
							...
							System.out
									.print("Patient " + releasedPatient.toString() + " was released for a check out\n");
						}
					} catch (NumberFormatException ex) {
						System.out.print("Please enter a valid number\n");
					}
